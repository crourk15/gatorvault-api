/** US state geographic centroids for SVG footprint map projection. */

export type StateCentroid = { lat: number; lng: number };
...
export const ALL_STATE_CODES = Object.keys(US_STATE_CENTROIDS);
