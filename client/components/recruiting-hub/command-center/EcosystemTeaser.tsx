  ...
  return (
    ...
    >
      <div className="rh-cc-ecosystem">
        <a href={SITE_ROUTES.gatorNationLive} className="rh-cc-ecosystem__tile rh-cc-ecosystem__tile--live">
        ...
        <a href={SITE_ROUTES.schedule} className="rh-cc-ecosystem__tile rh-cc-ecosystem__tile--tickets">
          <span className="rh-cc-ecosystem__icon" aria-hidden>
            🎟️
          </span>
