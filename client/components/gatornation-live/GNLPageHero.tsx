...
export function GNLPageHero(): React.ReactElement {
  ...
  return (
    ...
    >
      ...
      <div className="gv-gnl__frame gv-gnl-hero__inner gv-gnl-hero__inner--centered">
        <span className="gv-gnl-hero__title-accent gv-gnl-hero__title-accent--top" aria-hidden="true" />
        <h1 className="gv-gnl-hero__title gv-gnl-hero__title--wireframe">{GNL_COPY.hero.title}</h1>
