...
const must = [
  ...
  ['components/vault/VaultNavLink.tsx', 'isNativeCatchAllDynamicHref'],
  ['components/vault/VaultNavLink.tsx', 'navigateVaultHref'],
  ['lib/native-boot-script.ts', 'consumeSpaPending'],
