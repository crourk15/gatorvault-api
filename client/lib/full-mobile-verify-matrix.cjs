...
const ROUTE_CHECKS = {
  ...
  recruiting: {
    ...
    sections: [
      ...
      { sel: '[data-testid="rh-elite-class-overview"]', label: 'Class overview', minText: 40 },
      { sel: '[data-testid="rh-signing-day-tracker"], [data-testid="rh-elite-commit-board"]', label: 'NSD / commits', minText: 20 },
      { sel: '[data-testid="rh-elite-heat-index"]', label: 'Heat index', minText: 20, noSkeleton: true },
      ...
      { sel: '[data-testid="rh-elite-battles"]', label: 'Battles & movement', minText: 20, noSkeleton: true },
