...
export const DEPTH_CHART_OFF: DepthChartRow[] = [
  { pos: 'QB', s: 'Aaron Philo', si: 'R-So.', b: 'Tramell Jones Jr.', bi: 'R-Fr.', third: 'Aidan Warner (R-Jr.)', status: 'battle', analysis: 'Open QB competition into fall camp. Philo is the early lean; Jones Jr. is the primary challenger. Sumrall has not named a starter.' },
  ...
  { pos: 'WR (X)', s: 'Dallas Wilson', si: 'R-Fr.', b: 'Micah Mays Jr.', bi: 'R-Jr.', third: 'Kahleil Jackson (R-Sr.)', status: 'battle', analysis: 'Wilson is winning grass in camp and leads the X lean; Mays Jr. is still pushing.' },
  ...
  { pos: 'LT', s: 'Emeka Ugorji', si: 'So.', b: 'Tavaris Dice', bi: 'R-Fr.', third: 'Tyler Chukuyem (Fr.)', status: 'locked', analysis: 'Ugorji is the current LT lean into camp.' },
  ...
  { pos: 'RG', s: 'Bryce Lovett / TJ Shanahan', si: 'R-Jr. / R-Jr.', b: 'Roderick Kearney', bi: 'R-Jr.', third: 'Desmond Green (Fr.)', status: 'battle', analysis: 'Open RG battle between Lovett and Shanahan.' },
  { pos: 'RT', s: 'Caden Jones', si: 'R-So.', b: 'Eagan Boyer', bi: 'R-So.', third: 'Javarii Luckas (Fr.)', status: 'battle', analysis: 'Jones holds the early RT lean; Boyer is still in the fight.' },
];

export const DEPTH_CHART_DEF: DepthChartRow[] = [
  { pos: 'DT', s: 'Jeremiah McCloud', si: 'So.', b: 'Jamari Lyons / Joseph Mbatchou', bi: 'R-Sr. / So.', third: 'Mason Clinton (R-Jr.)', status: 'locked', analysis: 'McCloud is the current starting DT lean.' },
  ...
  { pos: 'JACK', s: 'Jayden Woods', si: 'So.', b: 'KJ Ford', bi: 'Fr.', third: 'Kofi Asare (R-Sr.)', status: 'locked', analysis: 'Jayden Woods is the best player on this defense.' },
  ...
  { pos: 'CB', s: 'Dijon Johnson', si: 'R-Jr.', b: "J'Vari Flowers", bi: 'So.', third: 'Jordy Lowery (R-Sr.)', status: 'locked', analysis: 'Johnson is a physical press-man corner — Sumrall already elevated his camp profile.' },
  ...
  { pos: 'STAR', s: 'Kanye Clark', si: 'R-So.', b: 'DJ Coleman', bi: 'Sr.', third: 'Elijah Owens (So.)', status: 'battle', analysis: 'Open STAR/nickel battle — Clark holds the early lean over Coleman.' },
  ...
  { pos: 'FS', s: 'Cam Dooley', si: 'Jr.', b: 'DJ Coleman', bi: 'Sr.', third: 'Alfonzo Allen Jr. (Sr.)', status: 'battle', analysis: 'Dooley is the FS lean; Coleman can slide here depending on STAR.' },
];
...
export const DEPTH_CHART_ST: DepthChartRow[] = [
  ...
  { pos: 'K', s: 'Patrick Durkin', si: 'R-So.', b: 'Brandon Rabasco', bi: 'R-So.', third: 'Liam Padron (R-So.)', status: 'locked', analysis: 'Durkin won the job in spring and remains the lean.' },
