...
const LEGACY_ROUTE_REDIRECTS = [
  ...
  { from: '/futurecast/master-board/', to: '/vault/futurecast' },
  { from: '/futurecast/master-board/*', to: '/vault/futurecast' },
  { from: '/futurecast/trending-board', to: '/vault/futurecast#fc-trending' },
  { from: '/futurecast/trending-board/', to: '/vault/futurecast#fc-trending' },
  { from: '/futurecast/trending-board/*', to: '/vault/futurecast#fc-trending' },
  { from: '/futurecast/movement-intel', to: '/vault/futurecast#fc-movement' },
  { from: '/futurecast/movement-intel/', to: '/vault/futurecast#fc-movement' },
  { from: '/futurecast/movement-intel/*', to: '/vault/futurecast#fc-movement' },
  { from: '/futurecast/staff-notes', to: '/vault/futurecast#fc-signals' },
  { from: '/futurecast/staff-notes/', to: '/vault/futurecast#fc-signals' },
  { from: '/futurecast/staff-notes/*', to: '/vault/futurecast#fc-signals' },
  { from: '/futurecast/stock', to: '/vault/futurecast#fc-master' },
  { from: '/futurecast/stock/', to: '/vault/futurecast#fc-master' },
  { from: '/futurecast/stock/*', to: '/vault/futurecast#fc-master' },
  { from: '/futurecast/snapshots', to: '/vault/futurecast#fc-hero' },
  { from: '/futurecast/snapshots/', to: '/vault/futurecast#fc-hero' },
  { from: '/futurecast/snapshots/*', to: '/vault/futurecast#fc-hero' },
  { from: '/futurecast/alerts', to: '/vault/futurecast#fc-feed' },
  { from: '/futurecast/alerts/', to: '/vault/futurecast#fc-feed' },
  { from: '/futurecast/alerts/*', to: '/vault/futurecast#fc-feed' },
  { from: '/vault/futurecast/trending', to: '/vault/futurecast#fc-trending' },
  { from: '/vault/futurecast/trending/', to: '/vault/futurecast#fc-trending' },
  { from: '/vault/futurecast/movement', to: '/vault/futurecast#fc-movement' },
  { from: '/vault/futurecast/movement/', to: '/vault/futurecast#fc-movement' },
  { from: '/vault/futurecast/staff', to: '/vault/futurecast#fc-signals' },
  { from: '/vault/futurecast/staff/', to: '/vault/futurecast#fc-signals' },
  { from: '/vault/futurecast/stock', to: '/vault/futurecast#fc-master' },
  { from: '/vault/futurecast/stock/', to: '/vault/futurecast#fc-master' },
  { from: '/vault/futurecast/snapshots', to: '/vault/futurecast#fc-hero' },
  { from: '/vault/futurecast/snapshots/', to: '/vault/futurecast#fc-hero' },
  { from: '/vault/futurecast/alerts', to: '/vault/futurecast#fc-feed' },
  { from: '/vault/futurecast/alerts/', to: '/vault/futurecast#fc-feed' },
