...
export const SCHEME_SCHOOL_LESSONS: SchemeSchoolLesson[] = [
  ...
  },
  {
    ...
    unit: 'offense',
    staff: 'Buster Faulkner — OC · OL (Trautwein)',
  ...
  },
  {
    ...
    title: 'TE Usage',
    unit: 'offense',
    staff: 'TE coach · Graham / McKissack role',
    dek: 'Seams, red zone, and inline blocking.',
    body: 'UF uses tight ends in seams vs zone, as extra protection in pass pro, and as red-zone targets when linebackers bite on run fakes. McKissack-type players who block and catch keep 12 personnel honest for Faulkner.',
  ...
  },
  {
    ...
    title: 'OL Technique',
    unit: 'offense',
    staff: 'Robbie Trautwein — OL coach',
  ...
  },
  {
    ...
    title: 'JACK Role',
    unit: 'defense',
    staff: 'Jayden Woods · Greg Gasparato — LB coach',
    dek: 'Edge setting, pass rush, and contain.',
    body: 'JACK is the scheme centerpiece — set the edge vs run, rush the passer, and contain mobile QBs. Woods-type players need length, burst, and block shedding to play the spot in White\'s odd front.',
  ...
  },
  {
    ...
    title: 'STAR Role',
    unit: 'defense',
    staff: 'Kanye Clark · Cormani Collins — DB coaches',
  ...
  },
  {
    ...
    unit: 'defense',
    staff: 'Will Harris + Cormani Collins — DB coaches',
  ...
  },
  {
    ...
    unit: 'performance',
    staff: 'Mike Whitt — Director of Strength & Conditioning',
  ...
  },
  {
    ...
    body: 'Year-round conditioning cycles peak for September openers and maintain through rivalry week. Whitt\'s themes — recover fast, compete every snap — align with Napier\'s standard for a physical SEC program.',
