...
export const SCHEDULE_GAMES: ScheduleGame[] = [
  ...
  },
  {
    ...
    ufPct: 96,
    tv: "SECN+",
    keys: ["Hold for film desk", "Boxes on file only", "No coverage watch yet"],
    swing: [
      { name: "Aaron Philo", role: "Pending film desk" },
      { name: "Jaden Baugh", role: "Pending film desk" },
      { name: "Jayden Woods", role: "Pending film desk" },
    ],
    filmWatched: false,
    film: "Film desk pending vs Campbell. No Hudl watch. Boxes are on file. Do not treat this as tape.",
    pred: "UF 42 · Campbell 7",
    predUF: 42,
    predOpp: 7,
    opponentTendencies: [
      "Film desk pending. Boxes only until tape is watched.",
      "2025 they averaged 23 a game and 346 yards. The 2026 ETSU opener was 49 points and 514 yards.",
      "Do not treat those numbers as On Tape.",
    ],
    defenseTendencies: [
      "Last year that defense gave up 37 a game and 27 pass TDs. That is a box line, not a tape watch.",
      "New coordinator this year. We have not watched coverage.",
    ],
    howUFWins: [
      "Hold. No Campbell tape watch yet.",
      "Box numbers are on the scout log. Do not write keys from boxes.",
      "Start Game Week Intel after film desk confirms the tape.",
    ],
    scoutingReport:
      "HOLD FOR FILM DESK. CAMPBELL boxes are on file (not a Hudl watch): Braxton Harris / OC Matt Kubik, QB Kamden Sixkiller. 2025 official line 23.45 PPG / 346.1 YPG. 2026 opener at ETSU (Aug 29) was 49-37, 514 yards — Sixkiller 29/42 for 343, 10-95 rushing, four TDs. Defense 2025: 37.18 PPG / 430.3 YPG allowed, 27 pass TDs vs 5 INTs. New DC Brandon Butcher. Coverage shells and fronts are NOT confirmed. Do not start fan Game Week prep until Charles watches tape.",
    filmNotes: [
      "Film desk pending. We have not watched Campbell tape.",
      "Boxes are on file. Do not treat this week as On Tape.",
      "Game Week Intel starts after the film watch.",
    ],
    offenseScout: [
      "PROVISIONAL — no Hudl watch. Boxes + staff-public only. Do not treat as film-confirmed. Game prep HOLD until tape.",
      ...
      "ESPN+ ETSU broadcast exists (Aug 29). Booth call is not a picture watch. Do not mark filmWatched true from it.",
    ],
    defenseScout: [
