...
export const SCHEDULE_GAMES: ScheduleGame[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      "Do not let the vertical get behind you",
    ...
    howUFWins: [
      "Sixkiller sat in the gun at ETSU (29/42, 343, 0 sacks) and still ran for 95 and two scores. Pressure before the first read and keep contain on the keep.",
      ...
      "They scored on seven of 11 full possessions at ETSU and put up 49. Stay on schedule, finish red-zone trips, and keep special teams clean so this does not become a track meet.",
    ],
    scoutingReport:
      "CAMPBELL OFFENSE (ESPN+ ETSU broadcast + official PBP, Aug 29): no-huddle shotgun on every Campbell snap charted; no under-center. Sixkiller 29/42 for 343, 0 INT, 0 sacks, plus 10-95 rushing and two keep/scramble TDs. Confirmed verticals: Austin 30-yd TD (wide-open / busted coverage on the call) and 50-yd catch; Keener 26-yd TD walking in. Gullette used as a space back (26-yd run). RPO mesh not confirmed. CAMPBELL DEFENSE (that broadcast + 2025 boxes): allowed 528 yards / 37 at ETSU with 0 sacks; two forced fumbles (Garza, Bedada). 2025 cumulative 37.18 PPG / 430.3 YPG, 27 pass TDs vs 5 INTs. New DC Brandon Butcher. Coverage shells NOT confirmed on broadcast angles. WCU Sep 5 postponed. UF wins by crowding Sixkiller, running at last year's front, and finishing drives.",
    filmNotes: [
      "No-huddle shotgun every snap we have. No under center.",
      "Sixkiller is the show. He can throw it and run it.",
      "They will take the deep shot. Austin was wide open for 30. Keener walked in from 26.",
