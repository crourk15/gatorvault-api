...
const VAULT_TO_SITE_REDIRECTS = [
  ...
  { from: '/futurecast/trending', to: '/futurecast#fc-trending', status: 301 },
  { from: '/futurecast/trending/', to: '/futurecast#fc-trending', status: 301 },
  { from: '/futurecast/movement', to: '/futurecast#fc-movement', status: 301 },
  { from: '/futurecast/movement/', to: '/futurecast#fc-movement', status: 301 },
  { from: '/futurecast/staff', to: '/futurecast#fc-signals', status: 301 },
  { from: '/futurecast/staff/', to: '/futurecast#fc-signals', status: 301 },
  { from: '/futurecast/trending-board', to: '/futurecast#fc-trending', status: 301 },
  { from: '/futurecast/trending-board/*', to: '/futurecast#fc-trending', status: 301 },
  { from: '/futurecast/movement-intel', to: '/futurecast#fc-movement', status: 301 },
  { from: '/futurecast/movement-intel/*', to: '/futurecast#fc-movement', status: 301 },
  { from: '/futurecast/staff-notes', to: '/futurecast#fc-signals', status: 301 },
  { from: '/futurecast/staff-notes/*', to: '/futurecast#fc-signals', status: 301 },
  { from: '/futurecast/stock', to: '/futurecast#fc-master', status: 301 },
  { from: '/futurecast/stock/*', to: '/futurecast#fc-master', status: 301 },
  { from: '/futurecast/snapshots', to: '/futurecast#fc-hero', status: 301 },
  { from: '/futurecast/snapshots/*', to: '/futurecast#fc-hero', status: 301 },
  { from: '/futurecast/alerts', to: '/futurecast#fc-feed', status: 301 },
  { from: '/futurecast/alerts/*', to: '/futurecast#fc-feed', status: 301 },
];
