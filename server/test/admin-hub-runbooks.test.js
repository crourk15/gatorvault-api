/**
 * Runbooks Charles-friendly fail copy + wake lock.
...
describe('Admin Hub runbooks', () => {
  it('explains wake failures in plain English', () => {
    ...
    const sandbox = { window: {}, console, document: { getElementById: function () { return null; } }, sessionStorage: { getItem: function () { return null; } } };
