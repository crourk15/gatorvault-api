...
test('stale / undated offers are not Home NOW fresh', () => {
  ...
  assert.equal(
    isFreshHomeNowOffer(
      { date: '2026-08-20', reportedAt: '2026-08-26T11:00:00.000Z' },
      now
    ),
    true
  );
  ...
  assert.ok(HOME_NOW_OFFER_MAX_AGE_MS === 14 * 24 * 60 * 60 * 1000);
});
