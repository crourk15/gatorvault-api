...
describe('FAU Week 1 highlights land on the Highlights hub', () => {
  it('manual catalog includes official cut and not the SEC condensed', () => {
    ...
    assert.doesNotMatch(blob, /Condensed Game/i);
  ...
  it('film-room catalog hub lists the official cut under Highlights', () => {
