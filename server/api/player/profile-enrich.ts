...
export async function augmentPlayerFromRecruiting(
  ...
  return {
    ...
    // Live On3 Industry Consensus wins over stale Postgres/stamp fields.
    compositeRating: recruiting.rating ?? player.compositeRating ?? null,
    rankingNational: recruiting.natlRank ?? player.rankingNational ?? null,
    rankingPosition: recruiting.posRank ?? player.rankingPosition ?? null,
    rankingState: recruiting.stateRank ?? player.rankingState ?? null,
