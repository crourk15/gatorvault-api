...
const { runSectionChecks } = require('../crawler/checks/integrity');
const { runPageChecks } = require('../crawler/checks/pages');
const { runUxChecks } = require('../crawler/checks/ux');
const { runBrowserChecks } = require('./qa-browser-checks');
const { runMobileBehaviorChecks } = require('./qa-mobile-behavior-checks');
const { runVisualIntegrityChecks } = require('../crawler/checks/visual-integrity');
