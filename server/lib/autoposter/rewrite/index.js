...
const { CHAR_LIMIT, MAX_REWRITE_ATTEMPTS, GENERIC_BANNED, MECHANICAL_BANNED, INSIDER_VOCAB, isPr6ShadowMode, isPr6Enabled, isPr789ShadowMode, isPr789Enabled } = require('./rewrite-types');
const { isPr6GoldenBeat, shouldUsePr6Live, shouldUsePr789Live, PR6_SOFT_LAUNCH_SLUGS, resolveGoldenBeatId } = require('./golden-beats');
