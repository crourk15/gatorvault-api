...
function main() {
  ...
  console.log(JSON.stringify({ ok: true, classYear: 2028, total: ALLOWLIST_2028.length, pendingCount: pending.length, resolvedCount: resolved.length, pending, resolved }, null, 2));
