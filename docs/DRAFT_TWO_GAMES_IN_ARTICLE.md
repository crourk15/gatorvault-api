...
Florida wins there if they start the game, do not take flags, and throw it when Auburn puts extra bodies near the line to stop Baugh. Get to Byrum Brown before he finds that first option, and do not chase the fake and leave him a running lane. Tackle Singleton, Koger, and Nimrod after the catch. Do not take the flags. The first two home games only hold up if the mistakes that did not matter last Saturday do not decide this one.
...
- Seven flags after halftime shoved drives into 1st-and-25. The flags were on the offensive line. Up 45-3 those flags do not change the score. If they show up when the game is still close, they are how you lose.
...
- Philo went 16-of-21 in each game (517 yards, five touchdowns, one interception combined). Baugh has the long run. After halftime the line stopped its own drives.
