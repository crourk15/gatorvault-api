...
- Seven flags after halftime shoved drives into 1st-and-25. The offensive line took them. Up 45-3 that is a film-room problem. In a real game it is how you lose.
- Defense has not opened a game with a three-and-out. Campbell kicked a field goal and went away. Byrum Brown will not.
- Philo went 16-of-21 in each game (517 yards, five touchdowns, one interception combined). Baugh has the long run. After the break the line stopped its own drives.
- At Auburn: start the game, stay clean, throw over extra bodies if they load up to stop Baugh, get to Byrum Brown early, tackle Singleton, Koger, and Nimrod after the catch.
