...
|---|---|---|---|
| 2026-09-06 | Game Week: default to next upcoming kickoff + empty Expected visitors state | `VaultGameWeekPage` / Command Center / `defaultGameWeekId` in binary; **Campbell intel + empty visitor list already live via API** | pending |
