...
|---|---|---|---|
| 2026-09-21 | Home NOW elite: this-week game lead + named process stack (Ole Miss / Saturday visits), class metrics capped at 1 | `HomeCommandCenter` + `home-command-utils` in binary. **Ticker API already ranks game week + visits after Render.** Do not start Codemagic. | pending |
