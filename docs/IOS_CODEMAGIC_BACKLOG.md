...
- [x] War Room: Nick Carroll 2028 S provisional board eval — Alohi Gilman comp + ST/nickel → starter-ceiling projection (API / hidden from fan Vault Scouting until a real Hudl watch)
