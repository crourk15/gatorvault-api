...
- [x] Vault + allowlist: Domonic Williams Jr. 2028 CB on players / visit log / 2028 board / admin allowlist. No invented Florida % or film sit (`filmWatched` unset; Vault Scouting stays hidden). API after Render — no Codemagic.
